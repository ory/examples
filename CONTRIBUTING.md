...
in Ory Examples, please disclose by contacting us at security@ory.sh.
...
that your contribution won't clash with Ory Examples's direction. A great way to do this is via
...
- **Help with open issues.** We have a lot of open issues for Ory Examples and some of them may lack necessary information, some
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history and helps structure the changelog. Please refer to
   this [list of prefixes for Examples](https://github.com/ory/examples/blob/master/.github/semantic.yml) for an overview.
