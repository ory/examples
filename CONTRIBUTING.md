...
_Please note_: We take Ory Examples's security and our users' trust very seriously. If you believe you have found a security issue
in Ory Examples, please responsibly disclose by contacting us at security@ory.sh.
...
that your contribution won't clash or be obviated by Ory Examples's normal direction. A great way to do this is via
[Ory Examples Discussions](https://github.com/orgs/ory/discussions) or the [Ory Chat](https://www.ory.sh/chat).
...
- I have a question. Where can I get [answers to questions regarding Ory Examples?](#communication)
...
- I want to talk to other Ory Examples users. [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory Examples. Does Ory have
...
- **Give us a star.** It may not seem like much, but it really makes a difference. This is something that everyone can do to help
  out Ory Examples. Github stars help the project gain visibility and stand out.
...
- **Helping with open issues.** We have a lot of open issues for Ory Examples and some of them may lack necessary information,
...
Check out [Ory Examples Discussions](https://github.com/orgs/ory/discussions). This is a great place for in-depth discussions and
lots of code examples, logs and similar data.
...
If you want to receive regular notifications about updates to Ory Examples, consider joining the mailing list. We will _only_ send
...
[in our chat](https://www.ory.sh/chat) before getting started to ensure your work is consistent with Ory Examples's roadmap and
architecture.
...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform commit history and helps structure the changelog.  
   Please refer to this [list of prefixes for Examples](https://github.com/ory/examples/blob/master/.github/semantic.yml) for an
   overview.
...
5. have signed our [Contributor License Agreement](https://cla-assistant.io/ory/examples);
...
[docs](https://github.com/ory/examples/tree/master/docs) folder. Generate API and configuration reference documentation using
`cd docs; npm run gen`.

For further instructions please head over to [docs/README.md](https://github.com/ory/examples/blob/master/README.md).
...
- Private harassment is also unacceptable. No matter who you are, if you feel you have been or are being harassed or made
  uncomfortable by a community member, please contact one of the channel ops or a member of the Ory Examples core team
  immediately.
