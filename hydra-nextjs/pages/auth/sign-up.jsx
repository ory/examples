...
const SignUpForm = Nope.object().shape({
  ...
  password_confirm: Nope.string().oneOf(
    [Nope.ref("password")],
...
export default function SignUp({
  ...
  return (
    <>
      ...
      <form action={action} method="post">
        ...
        <div>
          ...
          {formErrors.password_confirm && (
            <div style={{ color: "red" }}>{formErrors.password_confirm}</div>
          )}
        </div>
        <div>
          <input
      ...
      <br />
      <div>
        <a href={action.replace(/^\/auth\/sign-up/, "/auth/sign-in")}>
          Sign into your account &raquo;
        </a>
      </div>
    </>
  )
