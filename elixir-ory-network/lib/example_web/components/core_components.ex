  ...
  def button(assigns) do
    ...
    <button
      ...
      class={[
        ...
        "bg-zinc-900 hover:bg-zinc-700 text-white active:text-white/80 dark:bg-zinc-700 dark:hover:bg-zinc-600",
        @class
      ]}
      {@rest}
    >
    ...
    <div>
      <label class="flex items-center gap-4 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class="rounded border-zinc-300 text-zinc-900 focus:ring-zinc-900 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 dark:focus:ring-zinc-500"
          {@rest}
        />
        {@label}
      </label>
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div>
      ...
      <select
        id={@id}
        name={@name}
        class="mt-2 block w-full rounded-lg border-zinc-300 bg-white text-zinc-900 focus:border-zinc-400 focus:ring-0 sm:text-sm dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100"
        multiple={@multiple}
        {@rest}
      >
    ...
    <div>
      ...
      <textarea
        ...
        class={[
          ...
          @errors == [] && "border-zinc-300 focus:border-zinc-400 dark:border-zinc-600 dark:focus:border-zinc-500",
