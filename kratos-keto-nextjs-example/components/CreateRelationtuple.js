...
function CreateRelationtuple() {
    ...
    if (ObjectName && RelationName && SubjectName) {
      ...
      try {
        const res = await axios.post(
          "http://localhost:4000/writerelation",
          data
        );
  ...
  return (
    <div className="flex flex-col  max-w-6xl  border-yellow-600 border border-2 rounded-md mt-5">
      <h1 className="text-center p-3 bg-gray-900 text-white">ADD RELATION</h1>
      <div className=" flex  mx-auto justify-between   items-center  container p-5 ">
...
export default CreateRelationtuple;
